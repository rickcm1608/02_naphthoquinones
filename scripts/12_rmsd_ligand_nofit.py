...
ref_structure = "system.pdb"   # external reference for protein alignment

protein_sel = "backbone"
ligand_sel = "resname UNK and not name H*"

output_csv = "rmsd_ligand_nofit.csv"
output_plot = "rmsd_ligand_nofit.png"

print("=== Ligand RMSD (no local fit, reference = frame 100) ===\n")
...
# ===============================
# ALIGN PROTEIN TO EXTERNAL REFERENCE
# ===============================
...
# ===============================
print("Computing ligand RMSD (no local fit, ref = frame 100)...")
...
# SAVE OUTPUT
# ===============================
df = pd.DataFrame({"Frame": frames, "RMSD_noFit_frame100": rmsd_values})
...
plt.title("Ligand RMSD — no local fit (reference = frame 100)")
plt.grid(alpha=0.3)
plt.tight_layout()

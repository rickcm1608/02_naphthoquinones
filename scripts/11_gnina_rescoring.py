...
traj = "prot_lig_prod_1-11_nw.dcd"
minimization = "Yes"
Skip = 1
...
for i, ts in enumerate(u1.trajectory[::Skip]):
    ...
    res = Chem.SDMolSupplier("score_gnina.sdf", True)[0]
...
print("Saved: gnina_affinity.csv, gnina_cnn_score.csv, gnina_cnn_affinity.csv")

...
trajectory = "prot_lig_prod_1-11_whole.dcd"
ref_structure = "system.pdb"   # rigid reference (initial docking pose)
...
print("=== Ligand RMSD vs initial docking pose (system.pdb) ===\n")
...
# ===============================
# ALIGN PROTEIN TO DOCKING POSE REFERENCE
# ===============================
print("Aligning trajectory (protein only) to system.pdb...")
...
# ===============================
# LIGAND REFERENCE = DOCKING POSE IN system.pdb
# ===============================
ref_positions = ligand_ref.positions.copy()

print("Ligand reference: docking pose from system.pdb\n")

# ===============================
# COMPUTE LIGAND RMSD (NO LOCAL FIT)
# ===============================
print("Computing ligand RMSD (ref = docking pose)...")
...
plt.title("Ligand RMSD — no local fit (reference = docking pose)")
plt.grid(alpha=0.3)
plt.tight_layout()

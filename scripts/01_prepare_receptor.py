...
"""
Prepare the receptor PDB for docking with UniDock/GNINA.
"""
...
# Use PDBFixer: add missing atoms and hydrogens at pH 7.4
...
# ---------- Convert receptor to PDBQT using OpenBabel ----------

...
# ======== Create output subfolder for pocket residues ========
...
# Columns from the P2Rank output CSV
...
# ======== User selection ========
Selection = "Pocket"     # Change to "Residues" to select residues manually
number = "0"             # Pocket number or comma-separated residue list: "147,150,155"

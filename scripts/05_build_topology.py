...
# Ligand parametrized with GAFF 2.11
...
print(f"PDB file written: {system_pdb}")

# -----------------------------
# BUILD SYSTEM FOR PARMED
# -----------------------------
...
print("AMBER files written:", amber_prmtop, amber_inpcrd)
print("Periodic topology built successfully!")

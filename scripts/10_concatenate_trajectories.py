#!/usr/bin/env python3
# =============================================
# CONCATENATE, CENTER, AND ALIGN
# THE PROTEIN-LIGAND COMPLEX TRAJECTORY
# =============================================
...
# 3. Re-wrap
print("> Applying unwrap and complex centering (ligand-safe)...")
transformations = [
...
# ==== ALIGNMENT ====
print("> Aligning on Cα (ligand follows protein)...")
...
if os.path.exists(traj):
    print(f"\n✅ Trajectory written successfully: {os.path.basename(traj)}")
else:
    print("\n❌ ERROR: Output file was not created.")

# ==== VERIFY WITH PYTRAJ ====
print("\n> Verifying with PyTraj...")
